...
class _BalanceListScreenState extends State<BalanceListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CU.getAppbar(context, "Balance List"),
        ...
        children: [
            ...
            child: ClipOval(
              child: Image.asset(
                item[CS.BankAccountName].toString().contains("Google Pay")
                    ...
                    : item[CS.BankAccountName].toString().contains("Paytm")
                        ? "assets/paytm.png"
                        : "assets/phonepay.png",
                height: 60,
              ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(item[CS.TransactionMobileNo],
                    style:
                        TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                Text(item[CS.TransactionNumber].toString(),
                    style: TextStyle(
