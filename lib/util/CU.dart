...
//  static String MobileNo = "";
  ...
  // ignore: non_constant_identifier_names
  static List<Color> AbsentGradientColor = [
    Color(0xFFf64a78),
    Color(0xFFff6ea6)
  ];

  // ignore: non_constant_identifier_names
  static List<Color> PresentGradientColor = [
    Color(0xFF28c8a8),
    Color(0xFF36de98)
  ];

  // ignore: non_constant_identifier_names
  static List<Color> HolidayGradientColor = [
    Color(0xFFfaa367),
    Color(0xFFf3bc64)
  ];
...
//                                  body();
  ...
  static Widget loadImage(
      {@required url, height, isShowLoader = false, color}) {
    return Container(
      color: Colors.transparent,
      child: CachedNetworkImage(
          imageUrl: url,
...
// ignore: non_constant_identifier_names
  static Widget getAppbar(BuildContext context, String Title,
      {List<Widget> actions, isCenter = false, bool isShowRightSide = true}) {
    ...
    print('TAG:: resJson >>>>>>>>>>>>>>> ${MainScreenState.resJson}');
    print('TAG:: userInfo >>>>>>>>>>>>>>> ${MainScreenState.userInfo}');
...
// ignore: non_constant_identifier_names
  ...
  static bool IsLogin({context, bool action = false}) {
    bool isLogin = !(MainScreenState.userInfo == null ||
        CU.IsEmptyOrNull(MainScreenState.userInfo[k_clientid].toString()));
    if (!isLogin && action)
      Navigator.of(context).pushAndRemoveUntil(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      launchURL(
                          "whatsapp://send?phone=91" + MobileNo + "&text=hi");
                    },
                    icon: Image.asset(
                      "assets/whatsapp.png",
                      height: 22,
